...
function Star(x, y, radius, color, yvelocity = 3 ){
    this.x = x
    this.y = y
...
function createMountainRange(mountainAmount,height,color){
    for(let i = 0;i < mountainAmount; i++){
        ...
        c.lineTo(i * mountainWidth + mountainWidth + 1000,canvas.height)
        c.lineTo(i * mountainWidth + mountainWidth / 2, canvas.height - height)
        c.lineTo( i * mountainWidth - 1000, canvas.height)
        c.fillStyle = color
        c.fill()
        c.closePath()
    }
